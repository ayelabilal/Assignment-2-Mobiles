...
console.log(mobiles["iphone"]["iphone7"]);

let dropdown1 = document.getElementById("brand");
let dropdown2 = document.getElementById("models");

function filterMobileNames() {
...
function filterMobileModels(models) {
...
dropdown1.addEventListener("change", () => {
  ...
  filterMobileModels(mobiles[dropdown1.value]);
});

dropdown2.addEventListener('chane',()=> {
  
} )

function removeAllOptions(dropdown2) {
